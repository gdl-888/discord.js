...
class TextBasedChannel {
   ...
   *  .catch(console.log);
   */
  send(content, options) { options = options || {};
   ...
   *  .catch(console.log);
   */
  sendTTSMessage(content, options) { options = options || {};
   ...
   */
  sendFile(attachment, fileName, content, options) { options = options || {};
    if (!fileName) {
   ...
   */
  createCollector(filter, options) { options = options || {};
