...
class ClientVoiceManager {
  ...
  _checkPendingReady(guildID) {
    ...
    if (pendingRequest.token && pendingRequest.sessionID && pendingRequest.endpoint) {
      var _pendingRequest = pendingRequest;
var channel = _pendingRequest.channel;
var token = _pendingRequest.token;
var sessionID = _pendingRequest.sessionID;
var endpoint = _pendingRequest.endpoint;
var resolve = _pendingRequest.resolve;
var reject = _pendingRequest.reject;
   ...
   */
  _sendWSJoin(channel, options) { options = options || {};
