...
class VoiceConnectionPlayer extends EventEmitter {
  ...
  convertStream(stream, obj) { var _obj = obj; var _obj$seek = _obj.seek; var seek = _obj$seek === undefined ? 0 : _obj$seek; var _obj$volume = _obj.volume; var volume = _obj$volume === undefined ? 1 : _obj$volume; var _obj$passes = _obj.passes; var passes = _obj$passes === undefined ? 1 : _obj$passes;
  ...
  playPCMStream(pcmStream, obj) { var _obj = obj; var _obj$seek = _obj.seek; var seek = _obj$seek === undefined ? 0 : _obj$seek; var _obj$volume = _obj.volume; var volume = _obj$volume === undefined ? 1 : _obj$volume; var _obj$passes = _obj.passes; var passes = _obj$passes === undefined ? 1 : _obj$passes;
    const options = { seek, volume, passes };
