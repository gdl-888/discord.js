...
class RESTMethods {
  ...
  sendMessage(channel, content, opt, file) {
	file = file || null;
	// { tts, nonce, disable_everyone, split } = {}
	var _opt = opt;
	var tts = _opt.tts;
	var nonce = _opt.nonce;
	var disable_everyone = _opt.disable_everyone;
	var split = _opt.split;
